...
public class AdjustPositionResponse1Parser extends BaseMessageParser {
  ...
  public Object parse() throws IOException {
    ...
    logger.info(String.format("Received Adjust Position Response #1 for roller: %016x. Position %d%%. Unknown1: 0x%02x. Unknown2: 0x%02x. Unknown3: 0x%02x. Unknown4: 0x%02x",
